...
export type AuditEvent =
  ...
  | 'task.resumed'
  | 'task.cancelled'
  | 'remote.actions.fetch.failed'
  | 'remote.actions.fetch.not_found'
  | 'remote.actions.circuit_open'
  | 'remote.actions.circuit_skipped'
  | 'remote.actions.circuit_reset'
  | 'remote.actions.batch.started'
  | 'remote.actions.applied'
